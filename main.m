...
%% generating mobile platform positions 
cell_length=600;
cell_width=600;
[renovation_cells_clustering_waypaths,renovation_cells_waypioints_onpath,renovation_cells_waypioints_onpath,renovation_cells_manipulatorbase_positions,manipulator_endeffector_positions]=room_renovation_cells_generation(room_plane_edge_cell,renovation_planes_edge_cell,renovation_manipulatorbase_planes,renovation_effective_waypaths,renovation_planes_norm_vector,cell_length,cell_width,path_interval);
